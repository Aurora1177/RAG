...
from .llm_env import ARK_API_KEY, MODEL, BASE_URL, OPENAI_COMPAT_EXTRA_BODY
...
def retrieve_documents(query: str, top_k: int = 5) -> Dict[str, Any]:
    ...
    if is_chroma():
        try:
            ...
            rerank_meta["retrieval_mode"] = "chroma_dense"
            ...
            return {
                ...
                "meta": {
                    ...
                    "rerank_model": RERANK_MODEL,
                    "rerank_endpoint": _get_rerank_endpoint(),
                    "rerank_error": "chroma_retrieve_failed",
